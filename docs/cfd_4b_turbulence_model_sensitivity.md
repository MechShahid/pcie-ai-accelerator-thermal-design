...
![CFD-4B temperature solid surfaces](../cfd/cfd_4b_80x120x35_ducted_sst_sensitivity/screenshots/cfd_4b_temperature_solid_surfaces.png)

### Static pressure on centre X-plane

![CFD-4B static pressure centre X-plane](../cfd/cfd_4b_80x120x35_ducted_sst_sensitivity/screenshots/cfd_4b_static_pressure_center_x_plane.png)
...
```text
cfd/cfd_4b_80x120x35_ducted_sst_sensitivity/results/README.md
